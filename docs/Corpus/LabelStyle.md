...
当下位名称含有专名（如“北京/ns 分行/n”、“南化村/ns 党支部/n”、“昌平/ns 分校/n”）时，也可脱离前面的上位名称单独标注为 nt。
...
② 大规模/d 调查/v 语言/n 的/u 实际/a 使用/vn 情况/n 是/v 一/m 项/q 重要/a 的/u 基础/n 工作/vn 。/w
...
⑶ ⑶ 同一部分动词具有名词特点一样，当一部分形容词在实际语料中具有以下 3 种语法功能之一时，也认为它具有名词特点，标注为 an。
